    ...
    <main id="top_up" class="moneyoperations">
        ...
        <div>
            ...
            <form class="box rgb-border">
                ...
                <input type="number" id="topupamount" placeholder="Сумма $0.00">
                ...
                <button type="submit" id="submittopup" class="helpbutton">Пополнить</button>
            </form>
        </div>
...
<script type="module">
    ...
    submit.addEventListener('click', function (e) {
        ...
        message('', 'off')
        input.value < 25 ? message('Минимальная сумма пополнения $25', 'alert') : '';

        let type = $('.paymethodblock.active').data('type');
        type === undefined ? message('Вы не выбрали метод оплаты', 'warning') : '';
